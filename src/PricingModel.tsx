        ...
        {step === 'PLANS' ? (
          <div className="p-8 md:p-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              {/* Diamond Plan - NEW */}
              <div className="relative border-2 border-cyan-300 rounded-2xl p-6 bg-gradient-to-b from-cyan-950/50 via-purple-950/30 to-black flex flex-col shadow-[0_0_40px_rgba(103,232,249,0.2)] hover:scale-105 transition duration-300 overflow-hidden">
                {/* Diamond sparkle effect */}
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                  <div className="absolute top-0 left-1/4 w-1 h-1 bg-white rounded-full animate-pulse opacity-60"></div>
                  <div className="absolute top-1/4 right-1/4 w-1 h-1 bg-cyan-300 rounded-full animate-pulse opacity-80" style={{animationDelay: '0.5s'}}></div>
                  <div className="absolute bottom-1/3 left-1/3 w-1 h-1 bg-purple-300 rounded-full animate-pulse opacity-70" style={{animationDelay: '1s'}}></div>
                  <div className="absolute top-1/2 right-1/3 w-0.5 h-0.5 bg-white rounded-full animate-pulse" style={{animationDelay: '1.5s'}}></div>
                </div>
                
                <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 text-black text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider flex items-center gap-1">
                   <span>💎</span> Ultimate
                </div>
                {billing === 'YEARLY' && (
                   <div className="absolute top-4 right-4 bg-cyan-400/20 text-cyan-300 text-xs font-bold px-2 py-1 rounded">
                      SAVE {calculateSavings(plans.DIAMOND.monthlyPrice, plans.DIAMOND.yearlyPrice)}%
                   </div>
                )}
                <div className="relative z-10">
                   <h3 className="text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-purple-300 to-pink-300 mb-1">Diamond Elite</h3>
                   <div className="flex items-baseline gap-1">
                ...
                <ul className="space-y-3 mb-8 flex-1 relative z-10">
                  <li className="flex items-start text-white text-sm"><span className="text-cyan-300 mr-2 mt-0.5">💎</span> <span><strong>AI Voice Cloning</strong></span></li>
                  <li className="flex items-start text-white text-sm"><span className="text-cyan-300 mr-2 mt-0.5">💎</span> <span><strong>AI Pose Detection</strong> (Dance Coach)</span></li>
                  <li className="flex items-start text-white text-sm"><span className="text-cyan-300 mr-2 mt-0.5">💎</span> <span><strong>AI Video Instructors</strong></span></li>
                  <li className="flex items-start text-white text-sm"><span className="text-cyan-300 mr-2 mt-0.5">💎</span> <span>Everything in Superstar</span></li>
                  <li className="flex items-start text-white text-sm"><span className="text-cyan-300 mr-2 mt-0.5">💎</span> <span>1-on-1 Coaching Sessions</span></li>
                  <li className="flex items-start text-white text-sm"><span className="text-cyan-300 mr-2 mt-0.5">💎</span> <span>Unlimited HD Exports</span></li>
                  <li className="flex items-start text-white text-sm"><span className="text-cyan-300 mr-2 mt-0.5">💎</span> <span>White-Glove Support</span></li>
                </ul>
                <button 
                  onClick={() => handleSelectPlan('DIAMOND')}
                  className="w-full py-3 rounded-xl bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 text-white font-bold hover:scale-105 transition shadow-lg relative z-10"
                >
                  Go Diamond 💎
                </button>
              </div>
                 ...
                 {selectedTier === 'DIAMOND' ? (
                   <>
                     <div className="flex items-center text-sm text-gray-300">
                       <div className="w-8 h-8 rounded-full bg-cyan-400/20 text-cyan-300 flex items-center justify-center mr-3 font-bold">💎</div>
                       AI Voice Cloning
                     </div>
                     <div className="flex items-center text-sm text-gray-300">
                       <div className="w-8 h-8 rounded-full bg-cyan-400/20 text-cyan-300 flex items-center justify-center mr-3 font-bold">💎</div>
               ...
               <form onSubmit={handlePayment} className="space-y-4">
                  ...
                  <button 
                    ...
                    className={`
                      ...
                      ${selectedTier === 'DIAMOND'
                        ? 'bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 text-white hover:scale-105'
                        : selectedTier === 'SUPERSTAR' 
